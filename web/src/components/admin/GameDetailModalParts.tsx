...
import { type BatterLine, type LineAnalysis, type PitcherLine } from "@/lib/api/analyticsTypes";
...
export function ScoreBox({ label, score, std, wp }: { label: string; score?: number; std?: number; wp?: number }) {
  return (
...
export function RateRow({ label, value }: { label: string; value?: number }) {
...
export function TwoColumnRates({ homeLabel, awayLabel, homeRates, awayRates, rateLabels }: {
...
export function MLBStats({ summary }: { summary: { home: any; away: any } }) {
...
export function BasketballStats({ summary, sport }: { summary: { home: any; away: any }; sport: string }) {
  const labels: [string, string][] = [
...
export function NHLStats({ summary }: { summary: { home: any; away: any } }) {
  const labels: [string, string][] = [
    ["goal_pct", "Goal"],
    ["save_pct", "Save"],
    ["blocked_pct", "Blocked"],
...
export function NFLStats({ summary }: { summary: { home: any; away: any } }) {
  const labels: [string, string][] = [
    ["td_pct", "Touchdown"],
    ["fg_pct", "Field Goal"],
    ["punt_pct", "Punt"],
...
export function LineAnalysisDisplay({ la, home, away }: { la: LineAnalysis; home: string; away: string }) {
...
export function PitcherStat({ label, value }: { label: string; value?: number }) {
  return (
...
export function PitcherMatchup({ homeTeam, awayTeam, homeSP, awaySP }: {
...
export function BattingTable({ batters }: { batters: BatterLine[] }) {
...
export function GameShape({ game, sport }: { game: any; sport: string }) {
  return (
