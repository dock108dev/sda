...
class SportsGameFlow(Base):
    ...
    # Top-level flow metadata. Nullable so historical rows that predate
    # these columns continue to read.
    ...
    source_counts: Mapped[dict[str, Any] | None] = mapped_column(JSONB, nullable=True)
