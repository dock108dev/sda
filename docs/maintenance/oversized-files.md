...
Refreshed on 2026-05-30 after the SSOT cleanup pass.
...
size target. Review these opportunistically when the owning area is next changed;
do not split them mechanically just to reduce line count.

| Lines | File |
| ---: | --- |
| 807 | `api/app/routers/sports/game_detail.py` |
...
| 697 | `api/app/scroll_down_mlb/schemas.py` |
...
| 578 | `web/src/app/admin/analytics/models/page.tsx` |
| 571 | `api/app/tasks/experiment_tasks.py` |
...
| 543 | `web/src/components/admin/GameDetailModal.tsx` |
| 543 | `web/src/app/admin/analytics/experiments/page.tsx` |
| 542 | `scraper/sports_scraper/live/ncaab_boxscore.py` |
| 541 | `api/app/analytics/core/simulation_engine.py` |
| 538 | `api/app/routers/fairbet/odds.py` |
| 517 | `api/app/analytics/datasets/mlb_pa_dataset.py` |
| 506 | `web/src/app/admin/analytics/batch/page.tsx` |
| 506 | `scraper/sports_scraper/services/ncaab_game_ids.py` |
| 506 | `api/app/services/timeline_validation.py` |
| 506 | `api/app/analytics/services/profile_service.py` |
| 504 | `scraper/sports_scraper/jobs/sweep_tasks.py` |
