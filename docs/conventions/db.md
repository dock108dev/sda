...
|--------------------|----------|-----------|
| Child-of-game (boxscore, PBP, job/run metadata) | `CASCADE` | Row is meaningless without the parent game |
| Join / association table | `CASCADE` | Removing either side of the join should remove the association |
