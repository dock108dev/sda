...
export type CardTextSpoilerLevels = {
  ...
  setupLine?: CardFieldSpoilerLevel | null;
  playLine?: CardFieldSpoilerLevel | null;
  updateLine?: CardFieldSpoilerLevel | null;
...
export type NarrativeCard = {
  ...
  renderType: "important_narrative" | "standard_pbp" | "full_pbp" | "play_unavailable" | string;
  ...
  scoreAfter?: ScoreObject | null;
  scoreBeforeDisplay?: string | null;
  scoreAfterDisplay?: string | null;
  situationBeforeDisplay?: string | null;
  situationAfterDisplay?: string | null;
